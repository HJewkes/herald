...
describe('checkBudget', () => {
  ...
  it('sums tokens from current week journal entries', () => {
    ...
    vi.mocked(readEntries).mockReturnValue([
      { timestamp: '2026-02-18T10:00:00Z', taskId: 'a', taskTitle: 'A', status: 'success', durationMs: 1000, tokensUsed: 100000 },
      { timestamp: '2026-02-17T10:00:00Z', taskId: 'b', taskTitle: 'B', status: 'success', durationMs: 1000, tokensUsed: 200000 },
      { timestamp: '2026-02-10T10:00:00Z', taskId: 'c', taskTitle: 'C', status: 'success', durationMs: 1000, tokensUsed: 999999 }, // last week
    ]);
  ...
  it('handles entries with missing tokensUsed', () => {
    ...
    vi.mocked(readEntries).mockReturnValue([
      { timestamp: '2026-02-18T10:00:00Z', taskId: 'a', taskTitle: 'A', status: 'success', durationMs: 1000 },
    ]);
